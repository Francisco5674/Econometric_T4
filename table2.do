...
reg `outcome' treatment strata* _z_irt*bl if `conditions_proj', cluster(school_code) 
...
reg `outcome' treatment  strata* _z_irt*bl *pec_2016 if `conditions_pec' & `conditions_proj', cluster(school_code) 
